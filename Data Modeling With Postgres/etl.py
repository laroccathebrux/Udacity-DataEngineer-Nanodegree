...
def process_song_file(cur, filepath):
    """
    Reads from directory song datasource and loads data into song and artist tables
    This function iterates for each file founded in the directorys - one by one
...
def process_log_file(cur, filepath):
    """
    Reads from directory log and loads data into time, user and songplays tables
    This function iterates for each file founded in the directorys - one by one
    :param cur: Cursor object
    :param filepath: Source data location
    """
    ...
    for index, row in df.iterrows():
        ...
        if (songid != None or artistid != None):
