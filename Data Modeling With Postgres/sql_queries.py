...
song_select = ("""SELECT s.song_id, s.artist_id FROM songs AS s LEFT OUTER JOIN artists as a ON a.artist_id = s.artist_id WHERE s.title = %s AND a.name = %s AND s.duration = %s
""")
